...
:doctype: article
:description: In CISIS 12 Schritt 4 wird die IT-Doku-Struktur festgelegt
:keywords: CISIS 12, IT-Dokumentation, ISMS
:icons: font
...
- das Dokumentenmanagementmodul (DMS) (beschrieben in Kapitel _xref:isms-cisis-12:schritt-0-3.adoc[CISIS 12 Start]_),
