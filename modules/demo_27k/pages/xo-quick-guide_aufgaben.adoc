...
Im Benutzerprofil hat jeder Mitarbeiter die Möglichkeit eine Option für die automatische E-Mailbenachrichtigung zu wählen, um bei jeder Änderung im System entsprechend benachrichtigt zu werden.
